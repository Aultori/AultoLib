...
namespace AultoLib
{
    public class CommunicationTransmitterWorker_EMBroadcaster : CommunicationTransmitterWorker
    {
        ...
        {
            return pawn.health.capacities.CapableOf(AultoLib.PawnCapacityDefOf.EMBroadcasting);
        }
    }
}
