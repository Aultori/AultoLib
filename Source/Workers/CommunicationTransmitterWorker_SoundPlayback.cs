...
namespace AultoLib
{
    public class CommunicationTransmitterWorker_SoundPlayback : CommunicationTransmitterWorker
    {
        ...
        {
            return pawn.health.capacities.CapableOf(AultoLib.PawnCapacityDefOf.SoundPlayback);
        }
    }
}
